...
<meta property="og:title" content="Suno Music Prompt Laboratory — 126+ Cinematic Orchestral Experiments">
<meta property="og:description" content="Searchable archive of 126+ Suno AI prompts exploring 16 architectural forms of cinematic orchestral music. Embedded players, engineering notes, reproducible prompts.">
...
<meta name="twitter:description" content="126+ Suno AI prompt experiments exploring 16 architectural forms of cinematic orchestral music.">
...
<script type="application/ld+json">
{
  ...
  "description": "Searchable archive of 126+ iterative Suno AI prompts for cinematic, orchestral, and experimental music generation. Explores 16 architectural forms with embedded players and engineering notes.",
  "inLanguage": "en",
  "author": {
    "@type": "Person",
    "name": "Alexandru DAN",
    "url": "https://alexandrudan.com"
  },
  "publisher": {
    "@type": "Person",
    "name": "Alexandru DAN",
  ...
  "about": [
    {"@type": "Thing", "name": "Suno AI"},
    {"@type": "Thing", "name": "Prompt Engineering"},
    {"@type": "Thing", "name": "Cinematic Music"},
    {"@type": "Thing", "name": "Orchestral Music"},
    {"@type": "Thing", "name": "Film Score Composition"}
  ],
  "keywords": "Suno AI, prompt engineering, cinematic music, orchestral, film score, neoclassical, ambient, micropolyphony, passacaglia, fugue, canon, sonata, concerto grosso"
}
</script>
<style>
  :root {
  ...
  * { box-sizing: border-box; }
  ...
  .hidden { display: none; }
  .pagination { display: flex; align-items: center; justify-content: center; gap: 8px; margin: 36px 0 0; flex-wrap: wrap; }
  .pagination button { background: var(--panel); border: 1px solid var(--border); color: var(--text); padding: 8px 14px; border-radius: 8px; cursor: pointer; font-size: 0.85rem; transition: background 0.15s, border-color 0.15s; }
  .pagination button:hover { background: var(--panel-hover); border-color: #3a3a5a; }
  .pagination button.active { background: var(--accent); color: #0a0a0f; font-weight: 700; border-color: var(--accent); }
  .pagination button:disabled { opacity: 0.3; cursor: default; }
  .page-info { color: var(--muted); font-size: 0.82rem; margin: 0 8px; }
...
function renderPagination() {
  ...
  for (let i = 1; i <= tp; i++) {
    if (tp <= 7 || i === 1 || i === tp || Math.abs(i - currentPage) <= 1) {
  ...
  html += `<span class="page-info">${currentList.length} songs</span>`;
