...
> 7. **10k+ signal filter (2026-06-20, user directive):** mine the chart signal ONLY from high-traction songs (10,000+ views/plays) — learn from what's proven to resonate at scale — but still build ORIGINAL work. The user said "clone" top songs; cloning is plagiarism and is DECLINED — reframed as a signal filter (mine 10k+ for signal, produce original lyrics/style/title). See feedback_10k_signal_filter.
> 8. **Duration lever (confirmed v348 3:29 / v349 3:04 / v350 3:12-3:24 / v351 3:42-3:20):** to reliably clear 3:00, put an EXPLICIT lyric-free instrumental section (groove vamp / interlude / instrumental break, ~30-50s) in the MIDDLE of the lyrics. This — not BPM, not late timestamps alone — is what makes Suno render full length. See feedback_short_render_late_timestamp.
> 9. **10x MoA tournament (2026-06-20, "improve 10x"):** per cycle, after research+novelty reconcile, draft 3 candidates from DISTINCT viral angles in parallel (losers to scratchpad), tournament-judge all (each ≥90 + a danceability 1-10 rating), and submit ONLY the winner — highest score that is also strongly danceable/electronic/beat-driven (our audience's proven preference, see feedback_our_engagement_signal). See feedback_moa_tournament.
> 10. **Lean danceable/electronic (our engagement signal):** our audience likes beat-driven/electronic/danceable/edgy (dark techno, drill, dance, house); chamber/jazz/folk gets ~0 likes. Weight genre selection accordingly. See feedback_our_engagement_signal.
